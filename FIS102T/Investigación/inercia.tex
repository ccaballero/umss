...
El procedimiento para hallar el momento de inercia de una varilla delgada (vease
...
Para cada diferencial de longitud, se sabe que $r$ es equivalente al valor de
$|l|$:
...
\subsection{Varilla delgada vertical}
El procedimiento para hallar el momento de inercia de una varilla delgada (vease
la \textbf{Figura \ref{figura7}}) con eje en el centro de masa y paralelo a
su longitud ($L$), es el siguiente:

\begin{figure}
\centering
\includegraphics[scale=0.5]{resources/f7.eps}
\caption{Varilla delgada vertical}
\label{figura7}
\end{figure}
...
Para cada diferencial de longitud, se sabe que $r = 0$, por tanto:
